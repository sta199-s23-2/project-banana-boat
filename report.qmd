...
For our project, energy is considered renewable if it meets two criteria.

The energy must be derived from a naturally occurring source.

The energy is naturally replenished at a higher rate than it is consumed/used.
